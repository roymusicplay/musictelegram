...
async def pmPermit(client: USER, message: Message):
    if PMPERMIT == "ENABLE" and PMSET:
        ...
        await USER.send_message(
            message.chat.id,
            f"""**Hay saya adalah Layanan**\n╭━━━━━━━━━━━━━━━━━╮\n┣**Assistant [{PROJECT_NAME}](https://t.me/{BOT_USERNAME})**\n╰━━━━━━━━━━━━━━━━━╯\n**❗️ Rules:**\n- no Spam Pesan disini\n- Jangan Spam Lagu Biar Ga Error\n- Tutorial Cara Menggunakan bot Lihat di @{UPDATES_CHANNEL}\n\n━━━━━━━━━━━━━━━━━━━━━━\n**👉 KIRIM LINK INVITE ATAU USERNAME GRUP, PLEASE JOIN THIS GROUP @DOSTI_GROUP_1234 JOIN THIS CHANNEL @ABOUT_ABHINAS JIKA ASSISTANT TIDAK DAPAT BERGABUNG DENGAN GRUP ANDA.**\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n**💬 GROUP  :** @{SUPPORT_GROUP}\n**👮 OWNER :** @{OWNER}\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰""",
